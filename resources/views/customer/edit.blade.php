                    ...
                    <!-- <div class="tile-body">
                        <form class="row" method="POST" action="{{route('customer.update', $customer->id)}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="company_name" class="form-control @error('company_name') is-invalid @enderror" value="{{$customer->company_name }}" type="text" placeholder="Example: 111">
                                @error('company_name')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="contact_person" class="form-control @error('contact_person') is-invalid @enderror" value="{{$customer->contact_person }}" type="text" placeholder="Example: 111">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="post_code" class="form-control @error('post_code') is-invalid @enderror" value="{{$customer->post_code }}" type="text" placeholder="Example: 111">
                                @error('post_code')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="mobile_number" class="form-control @error('mobile_number') is-invalid @enderror" value="{{$customer->mobile_number }}" type="text" placeholder="Example: 111">
                                @error('mobile_number')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

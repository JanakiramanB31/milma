<div class="tile-body">
  <form method="POST" action="{{$submitURL}}">
    ...
    <div class="form-group col-md-12">
      ...
      <input name="previous_balance" class="form-control @error('previous_balance') is-invalid @enderror" 
    value="{{ 
      // Convert to float first, then format
      number_format(floatval(str_replace(',', '', old('previous_balance', $customer->previous_balance))), 2) 
    }}" 
    type="text" placeholder="Example: 111">

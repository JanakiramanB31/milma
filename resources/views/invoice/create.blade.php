          ...
          <div class="tile-body">
            <form  method="POST" action="{{route('invoice.store')}}">
                ...
                <div class="d-flex justify-content-end mb-3">
                  <a id="return-button-add" class="btn btn-info text-white"><i class="fa fa-plus"></i> Add Return Items</a>
                </div>
            ...
            <div id="return-table" style="display: none;">
              <h4>Return Items</h4>
              <table  class="table table-bordered" >
                <thead>
                  <tr>
                ...
                <!--<th scope="col">Discount %</th> -->
                    <th scope="col">Amount</th>
                    <th scope="col"><a class="add-Row badge badge-success text-white"><i class="fa fa-plus"></i> Add Row</a></th>
                  </tr>
                </thead>
                <tbody>
                  <tr>

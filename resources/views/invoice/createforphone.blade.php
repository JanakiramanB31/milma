                      ...
                      @else
                        @foreach($products as $product)
                          ...
                          <figure class="flex-{grow|shrink}-1">
                            <image class="product-select" data-qty="{{$product->quantity}}" data-id="{{$product->id}}" data-name="{{$product->name}}" src="{{ asset('images/product/' . ($product->image ?? 'default_image.png')) }}" width='80px' height='80px'/>
  
                            <figcaption style="width: 80px;"><p class="d-inline" style=" white-space: normal;word-wrap: break-word;overflow-wrap: break-word;">{{$product->name}}
                      ...
                      <table  class="table table-bordered" style="border-collapse: collapse;">
                        <thead>
                          <tr>
                            ...
                            <th scope="col" class="col-2">Qty</th>
                            <th scope="col" hidden>Price</th>
                            <th scope="col" class="col-3">Amt</th>

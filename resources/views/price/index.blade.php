...
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Manage Price</h1>
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Price</li>
                <li class="breadcrumb-item active"><a href="#">Manage Price</a></li>
            </ul>
        </div>
        <div class="">
            <a class="btn btn-primary" href="{{route('price.create')}}"><i class="fa fa-plus"></i> Add New Price</a>
        </div>
